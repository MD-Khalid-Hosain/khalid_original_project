                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="category_id" class="form-control" value="{{ $categorydata['id']}}">
                                            @error ('category_name')
                                             <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="form-group" style="text-align:center">
                                            @if (!empty($categorydata['category_image']) && $categorydata['category_image'] !='default.jpg') <img style="width: 200px" src="{{ asset('backend/uploads/category/'.$categorydata['category_image']) }}" alt="">&nbsp; <a class="confirmDelete" record="category-image" recordid="{{ $categorydata['id'] }}"  href="javascript:void(0)">Delete Image</a>
                                            @else
